...
/*   Updated: 2022/11/14 23:56:40 by calion           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void drawRays(t_gamedata *gamedata)
{
    ...
    /*Vertical Line check*/
	   ...
	   int color;
		if(distVerti < distHori)
		{
			...
			ray_y = vertiY;
			distT = distVerti;
			color = create_trgb(0,50,240,255);
		}
		if(distHori < distVerti)
		{
			...
			ray_y = horiY;
			distT = distHori;
			color = create_trgb(0,50,140,255);
		}
        drawLine(gamedata,gamedata->player_x + 2,gamedata->player_y+2,
        ray_x ,ray_y,0x0000FF00);
  ...
  //  DrawCube(gamedata,r*4,WallOffsetY,r*4,lineHeight+WallOffsetY,4);
	drawLine3d(gamedata,r/8,WallOffsetY,r/8,lineHeight+WallOffsetY,color);
